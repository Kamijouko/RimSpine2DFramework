...
namespace RimSpine2DFramework
{
    ...
    public sealed class EmbeddedDefLoader
    {
        ...
        private static readonly MethodInfo GiveShortHashMethod =
            typeof(ShortHashGiver).GetMethod("GiveShortHash", BindingFlags.Static | BindingFlags.Public, null,
                new[] { typeof(Def), typeof(Type) }, null)
            ?? typeof(ShortHashGiver).GetMethod("GiveShortHash", BindingFlags.Static | BindingFlags.NonPublic, null,
                new[] { typeof(Def), typeof(Type) }, null);

        private static readonly FieldInfo ShortHashField = typeof(Def).GetField("shortHash",
